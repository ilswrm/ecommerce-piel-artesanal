  ...
  app: {
    head: {
        ...
        meta: [
            ...
            { name: 'google-site-verification', content: 'AsUk2jzXdW98AqSr6phaQ5sZ7FL_jh82iElK85NyN-I' },
    ...
    },
    {
        innerHTML: `
                    ...
                    })(window,document,'script','dataLayer','GTM-KK969THR');
                `,
                type: 'text/javascript'
    }
],
noscript: [
    ...
    {
        innerHTML: `<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KK969THR" height="0" width="0" style="display:none;visibility:hidden"></iframe>`
    }
]
    }
}
